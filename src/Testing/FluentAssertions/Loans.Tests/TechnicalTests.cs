...
namespace Loans.Tests
{
    public class TechnicalTests
    {
        ...
        {
            typeof(IdentityVerifierServiceGateway)
                .Should()
                .Implement<IIdentityVerifier>();
        }
        ...
        public void AllValueObjectsInCorrectNamespace()
        {
            ...
            IEnumerable<Type> valueObjectTypes = 
                AllTypes
                .From(productionCodeAssembly)
                .ThatDeriveFrom<ValueObject>();

            valueObjectTypes
                .Should()
                .OnlyContain(x => x.Namespace == "Loans.Domain.Applications.Values");
        }
        ...
        public void NamespaceContainsOnlyValueObjects()
        {
            ...
            IEnumerable<Type> nonValueObjectTypesInNameSpace = 
                AllTypes
                .From(productionCodeAssembly)
            ...
            nonValueObjectTypesInNameSpace
                .Should()
                .BeEmpty();
        }
    }
